...
export default function BombDisplay({
  ...
  return (
    <div
      ...
      className="relative group opacity-0 w-[85vw] max-w-[384px]"
    >
      <Image
      ...
      <div className="absolute top-[31%] left-[48%] -translate-x-1/2 md:top-[119px] md:left-[185px]">
        <div className="bg-black border-2 border-white rounded-none px-2 py-1 shadow-[2px_2px_0px_0px_rgba(255,255,255,1)]">
          {!isRunning && (
            <span className="text-base md:text-xl font-black tracking-wider text-green-400 drop-shadow-[2px_2px_4px_rgba(0,0,0,0.8)]">
              SET FOCUS
            </span>
          )}
          <span
            className={`text-red-400 text-base md:text-xl font-black tracking-wider drop-shadow-[2px_2px_4px_rgba(0,0,0,0.8)] ${
